...
- (void)updateConstraints {
    ...
    [subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger idx, BOOL *stop) {
        ...
        if (idx > 0) {
            // Has previous
            NSLayoutConstraint *padding2 = [NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:subviews[idx - 1] attribute:NSLayoutAttributeBottom multiplier:1.f constant:0.f];
            [bezelConstraints addObject:padding2];
            [paddingConstraints addObject:padding2];
        }
    }];
...
- (void)updatePaddingConstraints {
    ...
    [self.paddingConstraints enumerateObjectsUsingBlock:^(NSLayoutConstraint *padding2, NSUInteger idx, BOOL *stop) {
        UIView *firstView = (UIView *)padding2.firstItem;
        UIView *secondView = (UIView *)padding2.secondItem;
        ...
        padding2.constant = (firstVisible && (secondVisible || hasVisibleAncestors)) ? MBDefaultPadding : 0.f;
